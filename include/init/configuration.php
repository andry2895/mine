...
if (empty($creation) && (!file_exists('config.inc.php') || !$valid_config)) {
    ...
    <p>'.tr('Benvenuto in _NAME_!', [
        '_NAME_' => '<strong>'.$nomesoftware.'</strong>',
    ]).'</p>
    ...
    echo '
                    <div id="step-2">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <span class="pull-left" title="'.tr('Visiona e accetta la licenza per proseguire').'">'.tr('Accetti la licenza di '). $nomesoftware. '?'.'*</span>
                            </div>
    ...
    echo '
                    <div id="step-3">
                        <a href="" target="_blank" ><img class="pull-right" width="32" src="'.$img.'/help.png" alt="'.tr('Aiuto').'" title="'.tr('Contatta il nostro help-desk').'"/></a>

                        <p>'.tr('Non hai ancora configurato ').$nomesoftware.'</p>
    ...
    echo '
                                <div class="col-md-4">
                                    {[ "type": "text", "label": "'.tr('Nome del database').'", "name": "db_name", "placeholder": "'.tr('Database').'", "value": "'.$name.'", "help": "'.tr('Esempio').': database", "show-help": 0, "required": 1 ]}
                                </div>
                            </div>';
