...
if (!empty($movimenti)) {
    ...
    echo '
        <table class="table table-striped table-condensed table-bordered">
            <tr>
                ...
                <th class="text-center" width="7%">Elimina</th>
            </tr>';
    ...
    foreach ($movimenti as $i => $movimento) {
        ...
        echo '
				...
				<br>'.$movimenti[$i]['descrizione_variante'].'</td>';
        ...
        // Operazioni
            ...
            echo '
                    <p><a href="'.$rootdir.'/editor.php?id_module=49&id_articolo='.$movimenti[$i]['idarticolo'].'&id_articolo_variante='.$movimenti[$i]['id_articolo_variante'].'&id_record='.$movimento['id'].'"> '.tr('Gestisci Variante').' </a></p>';
