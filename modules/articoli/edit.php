		...
		<div class="panel-body">
			<div class="row">
                ...
                <div class="col-md-9">
					...
					<div class="row">
                        <div class="col-md-6">
                            {[ "type": "select", "label": "<?php echo tr('Produttore'); ?>", "name": "produttore", "value": "$id_produttore$", "ajax-source": "produttori" ]}
                        </div>
			...
			<div class="row">
				<div class="col-md-12">
					{[ "type": "textarea", "label": "<?php echo tr('Nome'); ?>", "name": "descrizione", "required": 1, "value": "$descrizione$" ]}
				</div>
			</div>
            <div class="row">
                <div class="col-md-3">
			...
			<div class="row">
				<div class="col-md-12">
					{[ "type": "textarea", "label": "<?php echo tr('Descrizione'); ?>", "name": "note", "value": "$note$" ]}
				</div>
				<div class="col-md-12">
					{[ "type": "textarea", "label": "<?php echo tr('Nota Interna'); ?>", "name": "notainterna", "value": "$notainterna$" ]}
				</div>				
			</div>
		</div>
	</div>
...
?>
    ...
    <!-- informazioni web -->
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title"><?php echo tr('E-Commerce'); ?></h3>
                </div>

                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-6">
                            {[ "type": "checkbox", "label": "<?php echo tr('web'); ?>", "name": "web", "value": "$web$", "help": "<?php echo tr('Abilita la sincronizzazione dell articolo con E-commerce'); ?>", "placeholder": "<?php echo tr('Sincronizza Web'); ?>" ]}
                        </div>
