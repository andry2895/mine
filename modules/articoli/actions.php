...
switch (post('op')) {
    ...
    case 'update':
        ...
        $articolo->um = post('um');
		$articolo->id_produttore = post('produttore');
		...
		$articolo->abilita_varianti = post('abilita_varianti');
		...
		$articolo->notainterna = post('notainterna');
		
		$articolo->web = post('web');
		$articolo->meta_title = post('meta_title');
		$articolo->meta_keywords = post('meta_keywords');
		$articolo->meta_description = post('meta_description');
