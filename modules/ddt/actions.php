...
switch (post('op')) {
    ...
    case 'add_ordine':
		...
		$dbo->query('UPDATE or_righe_ordini INNER JOIN dt_righe_ddt ON or_righe_ordini.id = dt_righe_ddt.original_id INNER JOIN mg_movimenti ON dt_righe_ddt.idarticolo = mg_movimenti.idarticolo AND dt_righe_ddt.idddt = mg_movimenti.idddt INNER JOIN mg_articoli_varianti ON or_righe_ordini.id_articolo_variante =mg_articoli_varianti.id_web SET mg_movimenti.id_articolo_variante = or_righe_ordini.id_articolo_variante, mg_movimenti.descrizione_variante = mg_articoli_varianti.descrizione');
